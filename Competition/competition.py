...
trn_raw['Judgment Entry Date'] = trn_raw['Judgment Entry Date'].fillna("7/2/1996")
test_raw['Judgment Entry Date'] = test_raw['Judgment Entry Date'].fillna("7/2/1996")


subname1 = ['Payment Amount', 'Reduction Amount', 'Amount Due', 'Penalty Amount', 'Fine Amount', 'Interest Amount']
subname2 = ['Violation', 'License Type',  'Issue Month', 'Issue Year', 'Summons Number']
subname3 = ['Judge Year']

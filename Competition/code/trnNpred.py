...
trn_set['Payment VS Due'] = trn_raw['Payment Amount'] - trn_raw['Amount Due']
test_set['Payment VS Due'] = test_raw['Payment Amount'] - test_raw['Amount Due']
trn_set['Fine VS Reduction'] = trn_raw['Fine Amount'] - trn_raw['Reduction Amount']
test_set['Fine VS Reduction'] = test_raw['Fine Amount'] - test_raw['Reduction Amount']
#trn_set['Fine Total'] = trn_raw['Fine Amount'] - trn_raw['Penalty Amount'] - trn_raw['Interest Amount']
#test_set['Fine Total'] = test_raw['Fine Amount'] - test_raw['Penalty Amount'] - test_raw['Interest Amount']
#trn_set['Fine Rest'] = trn_raw['Payment Amount'] + trn_raw['Reduction Amount']
#test_set['Fine Rest'] = test_raw['Payment Amount'] + test_raw['Reduction Amount']
trn_set['Interest VS Reduction'] = trn_raw['Interest Amount'] - trn_raw['Reduction Amount']
test_set['Interest VS Reduction'] = test_raw['Interest Amount'] - test_raw['Reduction Amount']
#trn_set['Interest VS Due'] = trn_raw['Interest Amount'] - trn_raw['Amount Due']
#test_set['Interest VS Due'] = test_raw['Interest Amount'] - test_raw['Amount Due']
#trn_set['Payment VS Reduction'] = trn_raw['Payment Amount'] - trn_raw['Reduction Amount']
#test_set['Payment VS Reduction'] = test_raw['Payment Amount'] - test_raw['Reduction Amount']
#trn_set['Payment With Penalty'] = trn_raw['Payment Amount'] - trn_raw['Penalty Amount']
#test_set['Payment With Penalty'] = test_raw['Payment Amount'] - test_raw['Penalty Amount']
trn_set['Interest VS Payment'] = trn_raw['Interest Amount'] - trn_raw['Payment Amount']
test_set['Interest VS Payment'] = test_raw['Interest Amount'] - test_raw['Payment Amount']
...
issue_month_trn = trn_raw['Issue Date'].apply(lambda x: findMonth(x))
issue_month_test = test_raw['Issue Date'].apply(lambda x: findMonth(x))
...
judge_month_trn = trn_raw['Judgment Entry Date'].apply(lambda x: findMonth(x))
judge_month_test = test_raw['Judgment Entry Date'].apply(lambda x: findMonth(x))
...
trn_set['Month Span'] = issue_month_trn - judge_month_trn
test_set['Month Span'] = issue_month_test - judge_month_test

trn_set['Year Span'] = trn_set['Judge Year'] - trn_set['Issue Year']
test_set['Year Span'] = test_set['Judge Year'] - test_set['Issue Year']
...
trn_set['State VS County'] = trn_set['State'] - trn_set['County']
test_set['State VS County'] = test_set['State'] - test_set['County']

...
subname3 = ['Judge Year', 'Judge Month', 'Plate', 'Issuing Agency']
...
# FEATURE CATEGORY 3: Date --- Issue Date and Judgment Entry Date (Year & Month)
...
'''# OLD VERSION
#labels = np.unique(trn_raw['Plate'])
#print(labels.shape)
plate_dict = topDict(trn_raw['Plate'],59912)
#print(plate_dict)
